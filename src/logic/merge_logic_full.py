...
def merge_quiz_data():
    ...
    for _, row in quiz_df.iterrows():
        ...
        transformed_row = {
            ...
            'labels': convert_points_to_labels(row['points'])  # Map points to labels (0, 1, 2)
        }
    ...
    column_order = ['task_id', 'question', 'reference_answer', 'chunk_text', 'topic', 'student_answer', 'labels']
